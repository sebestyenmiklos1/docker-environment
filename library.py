...
def preprocess(line):
    ...
    if pwd:
        ...
        variables['JENKINS_USER_ID'] = None  # Jenkins user likely doesn't exist on Windows
...
def make_dockerfile(target):
    ...
    try:
        with open(dockerfile_in_path, 'r') as in_file, open(dockerfile_out_path, 'w') as out_file:
